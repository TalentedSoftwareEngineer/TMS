...
export const getFilter = (active: string, direction: string, size: number, page: number, filterValue: string, date1: string, date2: string, keys: string[], val?: string, customerFilter?: any, numberFields?: string) => {
  let filter = 'filter='
  let obj: FilterObj = {
    limit: size,
    skip: (page - 1) * size
